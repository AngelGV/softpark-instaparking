Rails.application.routes.draw do
  ...
  get      'offert/:idusuario/list', controller: :offert, action: :list, as: :listOffert
  get      'trasaction/:idrent_parking/paiment',controller: :trasaction, action: :paiment, as: :paiment
